  ...
  return (
    <div>
      ...
      <div className='flex justify-center items-center mt-8'>
        <div className={`${fontFamily}  text-white text-5xl tracking-wider mr-2`}>TypeBlitz</div>
        <div> <BiSolidKeyboard className="text-blue-500 text-5xl" /> </div>
      </div>
      ...
      <div className="flex justify-between text-2xl mr-20 ml-10 mt-10 ">
       ...
       <div className="tracking-wide text-2xl leading-normal ">
          <div className={`${fontFamily} text-gray-500 bg-gray-950 m-2 w-11/12 ml-10`}>{text}</div>
          ...
          <textarea 
            ...
            name="" id="my_textarea"  />
            <div onClick={fetchNewPara} className="text-white flex justify-center absolute bottom-10 left-1/2 cursor-pointer">
        ...
        <div className="ml-20 absolute bottom-2 text-white">

          {
            ...
            <div className=" border-2 p-2 rounded-md cursor-pointer">
              <div onClick={() => setFont("font-mono")} className="font-mono">font-mono</div>
              <div onClick={() => setFont("font-serif")} className="font-serif">font-serif</div>
              <div onClick={() => setFont("font-sans")} className="font-sans">font-sans</div>
              <div onClick={() => setFont("inherit")} className="inherit">inherit</div>
            </div>
          }

          <div className="flex items-center">
            <div className={`${fontFamily} text-white mr-1`}>{fontFamily}</div>
            <div className="text-white" onClick={() => setFontFamilyOpen(!fontFamilyOpen) } > 
              {
                (!fontFamilyOpen) ?
